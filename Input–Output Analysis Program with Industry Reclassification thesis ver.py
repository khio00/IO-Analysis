...
if choice == "0. 한국은행 데이터 정합성 검증":
    ...
    st.markdown("한국은행 33개 대분류 체계 기준 생산, 부가가치, 고용 유발계수를 산출하여 알고리즘의 정합성을 검증합니다.")
